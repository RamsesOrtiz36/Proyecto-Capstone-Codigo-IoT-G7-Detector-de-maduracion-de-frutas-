...
while True:                                                                                  #biri ciclo while para que se mantenga rebizando la coneccion a MQTT                       
    ...
    cursor1.execute("SELECT id, fruta, HSV FROM Calibraciones WHERE fruta='"+NombreFrutaPy+"'")    #Petición a MySQL para tomar los valores de los registros de la tabla que cumplen los requisitos
