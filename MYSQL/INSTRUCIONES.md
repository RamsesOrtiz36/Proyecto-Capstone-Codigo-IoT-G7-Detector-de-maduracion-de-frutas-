...
CREATE TABLE registro (id INT(6) UNSIGNED AUTO_INCREMENT PRIMARY KEY, fecha TIMESTAMP DEFAULT CURRENT_TIMESTAMP, fruta CHAR (248) NOT NULL, temp FLOAT(4,2) NOT NULL, hum INT(1) UNSIGNED NOT NULL, propano INT(1) UNSIGNED NOT NULL, alcohol INT(1) UNSIGNED NOT NULL, metano INT(1) UNSIGNED NOT NULL, dioxido de carbono INT(1) UNSIGNED NOT NULL,;
